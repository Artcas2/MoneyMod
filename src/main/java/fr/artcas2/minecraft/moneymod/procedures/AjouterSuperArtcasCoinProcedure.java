...
public class AjouterSuperArtcasCoinProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(new TextComponent(("+4 " + new TranslatableComponent("money").getString())), (false));
		(itemstack).shrink(1);
	}
}
